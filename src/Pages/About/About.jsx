      ...
      <div className="aboutContainer">
        <div className="sectionsContainer">
          <div className="sectionAbout">
            ...
            <div className="sectionAboutInfo">
              ...
              <p>
                ...
                engaging and responsive websites that enhance user experiences.
                I thrive on the challenge of problem-solving and love working
                with code to find solutions that exceed client expectations. My
                strong technical skills and ability to quickly adapt to new
                technologies enable me to approach projects efficiently and
                effectively.
              </p>
            </div>
            <p>
              This is a link to my CV: <br />
              <a
                href="dist/FullStack-WebdeveloperCV-AnnaVelarde.pdf"
                target="_blank"
                rel="noreferrer"
              >
                Download
          ...
          {/* <div className="experienceInfo">
            <h1>Experience.</h1>
            <div style={{ width: "500px", height: "850px" }}>
              <Chrono
                items={items}
